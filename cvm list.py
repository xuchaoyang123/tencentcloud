...
try:
    ...
    cred = credential.Credential("xxxxxxxx", "xxxxxxx")

    #解决[TencentCloudSDKException] code:ClientNetworkError message:[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:749) requestId:None
    ...
    respFilter.Values = ["ap-beijing-3"]
